...
2. **Preserve Everything (Preserve Tudo):** O código que já funciona é sagrado. Não reformatar, não reorganizar e não tentar "melhorar" trechos adjacentes sem solicitação explícita.
